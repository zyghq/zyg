...
const (
	...
	ErrClaimedEmail         = serviceErr("claimed email error")
	ErrClaimedEmailNotFound = serviceErr("claimed email not found")
	ErrClaimedEmailInvalid  = serviceErr("claimed email invalid")
	ErrClaimedEmailExpired  = serviceErr("claimed email expired")
)
