      ...
      <div className="px-4 sm:px-8 flex justify-between my-4">
        <div className="text-lg sm:text-xl font-medium items-center">
          <div className="flex items-center gap-x-2">
            <ReplyIcon className="my-auto w-5 h-5 text-indigo-500" />
            <span>Needs Next Response</span>
          </div>
        </div>
          ...
          <div className="container mt-4 sm:mt-24 max-w-md">
            <div className="border p-4 rounded-xl">
              <div className="font-medium text-sm">
                No threads need a next response.
              </div>
              <div className="text-muted-foreground text-sm">
                When a customer replies to an existing thread, it will
                automatically appear here for your team's next response.
              </div>
            </div>
          </div>
        </div>
