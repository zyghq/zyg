...
import { HOLD, STATUS_TODO } from "@/db/constants";
      ...
      <div className="px-4 sm:px-8 flex justify-between my-4">
        <div className="text-lg sm:text-xl font-medium items-center">
          <div className="flex items-center gap-x-2">
            <PauseIcon className="w-5 h-5 text-indigo-500" />
            <span>Hold</span>
          </div>
        </div>
        ...
        <div>
          <div className="container mt-4 sm:mt-24 max-w-md">
            <div className="border p-4 rounded-xl">
              <div className="font-medium text-sm">No threads are on hold.</div>
              <div className="text-muted-foreground text-sm">
                You can place a thread on hold when waiting on external input.
                It will appear here until the dependency is resolved and you're
                ready to continue.
              </div>
            </div>
          </div>
